...
<div class="row">
	<div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-one">
                            ...
                            <h2 class="m-b-20" data-plugin="counterup">11</h2>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-one">
                            ...
                            <h6 class="text-muted text-uppercase m-b-20">Completed Tasks</h6>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-one">
                            <i class="icon-paypal float-right text-muted"></i>
                            <h6 class="text-muted text-uppercase m-b-20">Pending Tasks</h6>
                            <h2 class="m-b-20">$<span data-plugin="counterup">46,782</span></h2>
                    ...
                    <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
                        <div class="card-box tilebox-one">
                            ...
                            <h2 class="m-b-20">$<span data-plugin="counterup">500</h2>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget nicescroll" style="height: 330px;">
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/images/users/avatar-8.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <a href="#">
                                            <div class="inbox-item">
                                                <div class="inbox-item-img"><img src="/images/users/avatar-9.jpg" class="rounded-circle" alt=""></div>
